...
#-----online----
#监控汇总日志，写入队列
sudo  /usr/local/php/bin/php /data/ifengsite/htdocs/log_monitor/monitor.php erweima >> /data/logs/logstash/monitor.log &
#读取队列，发送邮件
sudo  /usr/local/php/bin/php /data/ifengsite/htdocs/log_monitor/sendmail.php erweima >> /data/logs/logstash/sendmail.log &
